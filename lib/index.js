...
/***/function (module, exports, __webpack_require__) {
  ...
  var varintBufferEncode = __webpack_require__(5).varintBufferEncode;
...
/***/function (module, exports, __webpack_require__) {
  ...
  (function (Buffer) {
    ...
    var multibase = __webpack_require__(19);
    var multicodec = __webpack_require__(24);
    var codecs = __webpack_require__(2);
    var codecVarints = __webpack_require__(4);
      ...
      _createClass(CID, [{
        ...
        get: function get() {
          switch (this.version) {
            ...
            case 1:
              return Buffer.concat([Buffer.from('01', 'hex'), Buffer.from(codecVarints[this.codec]), this.multihash]);
            default:
              throw new Error('unsupported version');
          }
        }
        ...
        key: 'prefix',
        get: function get() {
          return Buffer.concat([Buffer.from('0' + this.version, 'hex'), codecVarints[this.codec], multihash.prefix(this.multihash)]);
        }
      }], [{
        key: 'isCID',
...
/***/function (module, exports, __webpack_require__) {
  ...
  (function (Buffer) {
    ...
    */
    ...
    var varint = __webpack_require__(1);
    var codecNameToCodeVarint = __webpack_require__(4);
    var codeToCodecName = __webpack_require__(25);
